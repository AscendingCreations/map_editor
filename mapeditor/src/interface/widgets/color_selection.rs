...
impl ColorEditor {
    pub fn new(systems: &mut DrawSetting, pos: Vec2, z_order: [f32; 3], data: [u8; 4], can_edit_alpha: bool, render_layer: [usize; 2]) -> Self {
        ...
        let lbl = create_basic_label(systems, 
        ...
        textbox.push(Textbox::new(systems, Vec3::new(content_pos.x + 20.0, content_pos.y - 25.0, ORDER_COLOREDIT_TEXTBOX),
                    Vec2::new(60.0, 24.0), false, render_layer));
        ...
        let button = Button::new(systems, systems.resource.preference_button.allocation, "Apply",
                ...
                [ORDER_COLOREDIT_BUTTON, ORDER_COLOREDIT_BUTTON_LABEL], 2.0, render_layer);
...
impl ColorSelection {
    pub fn new(systems: &mut DrawSetting, pos: Vec3, size: Vec2, color: [u8; 4], msg: Option<&str>, can_edit_alpha: bool, render_layer: [usize; 2]) -> Self {
        let mut img = Rect::new(&mut systems.renderer, 0);
        img.set_size(size).set_position(Vec3::new(pos.x, pos.y, pos.z))
        ...
        let color_editor = ColorEditor::new(systems,
                            ...
                            color.clone(), can_edit_alpha, render_layer);
    ...
    pub fn set_hover(&mut self, systems: &mut DrawSetting, is_hover: bool) {
        ...
        if self.is_hover {
            systems.gfx.set_border_color(self.image, Color::rgba(200, 200, 200, 255));
        } else {
            systems.gfx.set_border_color(self.image, Color::rgba(20, 20, 20, 255));
        }
    }
