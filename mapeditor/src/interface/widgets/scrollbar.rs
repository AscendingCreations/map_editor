...
impl Scrollbar {
    pub fn new(systems: &mut DrawSetting, pos: Vec3, max_value: usize, max_scroll_size: usize, min_bar_size: usize, render_layer: usize) -> Self {
    ...
    pub fn update_scroll_max_value(&mut self, systems: &mut DrawSetting, max_value: usize) {
        ...
        // Top Corner of Scrollbar
        systems.gfx.set_pos(self.images[0], 
            Vec3::new(self.default_pos.x, self.default_pos.y, self.default_pos.z));

        // Center of Scrollbar
        systems.gfx.set_pos(self.images[1], 
            Vec3::new(self.default_pos.x, self.default_pos.y - scrollbar_size as f32, self.default_pos.z));
        systems.gfx.set_size(self.images[1], 
            Vec2::new(10.0, scrollbar_size as f32));

        // Bottom Corner of Scrollbar
        systems.gfx.set_pos(self.images[2], 
            Vec3::new(self.default_pos.x, self.default_pos.y - scrollbar_size as f32 - 4.0, self.default_pos.z));
    ...
    pub fn in_scrollbar(&mut self, systems: &mut DrawSetting, mouse_pos: Vec2) -> bool {
        let (pos0, pos2, size) = (systems.gfx.get_pos(self.images[0]),
...
fn set_texture_state(systems: &mut DrawSetting, image: &mut Vec<usize>, state: TextureState) {
    match state {
        TextureState::Normal => {
